...
Multi-table export chains collide with automated backups and with each
...
Same operator family as pattern 39 (Hydra weekly full dump). Kept here
so this folder stays self-contained for review.
