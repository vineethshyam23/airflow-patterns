...
| 25 | SEO business-listing GCS ingest | `utilities/25-seo-gcs-ingest/` | `dags/etl_dataforseo_ingestion.py` + `dags/horeca_digital/dataforseo_gcs_ingest.py` + `schema_json/dataforseo_business_listing.json` | Shipped 2026-08-25 |
